...
public class AllureReportTest {
       ...
       public void SignUpTest() throws Exception {
    	   ...
    	   p.load(new FileInputStream("./input.properties"));								//podkluchaem file input.propertiesÏ
    	   
              // First Name
              setValueTest(By.id(p.getProperty("fname_id")), p.getProperty("fname_value"));
              assertElement(p.getProperty("fname_value"),									//eti dve stroki 
              Common.getValue(By.id(p.getProperty("fname_id"))));							//sveryaut value ustanovlennoe	
              // Last Name																	//metodom SetValueTest eto expected result
              setValueTest(By.id(p.getProperty("lname_id")), p.getProperty("lname_value")); // i value kotoroe, beret metod Common.getValue -eto 
              assertElement(p.getProperty("lname_value"),  									// actual result. V classe ExtentReport vse proshe.
       ...
       public void ConfirmationTest() throws Exception {
              ...
              Common.getValue(By.id(p.getProperty("fname_id"))));
              // Last Name
       ...
       public void setUp() throws Exception {
              if (browser == null) {
              System.err.println("Please provide browser: -Dbrowser=firefox");System.exit(0);}
       ...
       public void tearDowm() {Common.quit();}
}
